...
class AutomationActionEventHub(AutomationAction):
    ...
    :param action_type: Required. Constant filled by server.
    :type action_type: str
    :param event_hub_resource_id: The Event Hub Azure Resource ID.
    :type event_hub_resource_id: str
    :param connection_string: The Event Hub connection string (it will not be
     returned in GET).
...
class AutomationActionLogicApp(AutomationAction):
    ...
    :param uri: The Logic App trigger URI endpoint (it will not be returned in
     GET).
    :type uri: str
    """
