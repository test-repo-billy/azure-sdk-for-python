...
class WorkbookTemplatesOperations(object):
    ...
    def list_by_resource_group(
        ...
        :rtype:
         ~azure.mgmt.applicationinsights.models.WorkbookTemplatePaged[~azure.mgmt.applicationinsights.models.WorkbookTemplate]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.applicationinsights.models.WorkbookTemplate or
    ...
    def create_or_update(
        ...
        :type workbook_template_properties:
         ~azure.mgmt.applicationinsights.models.WorkbookTemplate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
