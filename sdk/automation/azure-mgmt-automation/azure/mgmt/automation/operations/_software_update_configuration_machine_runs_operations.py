...
class SoftwareUpdateConfigurationMachineRunsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.automation.models.SoftwareUpdateConfigurationMachineRunPaged[~azure.mgmt.automation.models.SoftwareUpdateConfigurationMachineRun]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.automation.models.ErrorResponseException>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.SoftwareUpdateConfigurationMachineRunPaged(internal_paging, self._deserialize.dependencies, header_dict)
