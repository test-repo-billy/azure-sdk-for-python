...
class ModelOperations(object):
    ...
    def get_properties(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ModelProperties or ClientRawResponse if raw=true
        :rtype: ~azure.cognitiveservices.personalizer.models.ModelProperties
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ModelProperties', response)
        ...
        return deserialized
    get_properties.metadata = {'url': '/model/properties'}
