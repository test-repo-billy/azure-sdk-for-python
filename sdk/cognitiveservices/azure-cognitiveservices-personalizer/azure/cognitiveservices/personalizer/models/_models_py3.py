...
class EvaluationContract(Model):
    ...
    :param enable_offline_experimentation: True if the evaluation should
     explore for a more optimal policy.
    ...
    :param policies: Required. Additional policies to evaluate.
    :type policies:
...
class PolicyContract(Model):
    ...
    :param name: Required. Name of the Policy.
    :type name: str
    :param arguments: Required. Arguments of the Policy.
    :type arguments: str
    """
...
class ServiceConfiguration(Model):
    ...
    :param model_export_frequency: Required. The time delay between exporting
     trained models.
