...
# USAGE
    python service_create_private_endpoint_connection.py
...
# x-ms-original-file: specification/healthcareapis/resource-manager/Microsoft.HealthcareApis/stable/2024-03-01/examples/legacy/ServiceCreatePrivateEndpointConnection.json
